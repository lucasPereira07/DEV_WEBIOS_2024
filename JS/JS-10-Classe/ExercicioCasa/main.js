...
const contaPoupanca = new ContaBancaria('Lucas', 30, 5000, 'Masculino', '001', 'Poupança', '123456-7');
const contaCorrente = new ContaBancaria('Lucas', 45, 7000, 'Masculino', '002', 'Estudante', '765432-1');
const contaEstudante = new ContaBancaria('Lucas', 22, 3000, 'Masculino', '003', 'Corrente', '112233-4');
